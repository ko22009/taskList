...
<form class="form" id="register">
    ...
    <input type="text" name="login" id="inputLogin" class="form-control first" placeholder="Логин" required=""
           autofocus="">
    ...
    <input type="password" name="pass2" id="inputPassword2" class="form-control" placeholder="Повторите пароль"
           required="">
